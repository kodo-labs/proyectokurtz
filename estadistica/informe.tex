...
En este trabajo buscamos aplicar lo que vimos en Probabilidad y Estadística a un caso concreto: nuestro proyecto de Ingeniería de Software II. El sistema que venimos desarrollando se llama BookDesk, y básicamente es una plataforma web para gestionar reservas de salas y escritorios en un espacio de coworking.
...
Trabajamos con datos simulados (50 observaciones para lo descriptivo y 30 para regresión) porque el sistema todavía no tiene suficiente historial real. Los datos los generamos tratando de que reflejen patrones de uso creíbles: reuniones cortas, jornadas parciales, jornadas completas, etc. Todos los cálculos y gráficos se procesan directamente dentro del sistema BookDesk, en un módulo de estadística integrado al panel de administración.
...
Usamos semillas fijas en el generador de datos para que los resultados sean reproducibles cada vez que se accede al módulo.
...
\begin{itemize}[itemsep=4pt]
  \item React 18 con Recharts para los cálculos estadísticos y la visualización de gráficos.
  \item JavaScript para el procesamiento de datos y las fórmulas (media, desvío, regresión, t-Student, etc.).
