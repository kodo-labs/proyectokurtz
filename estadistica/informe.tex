...
Trabajamos con datos simulados (50 observaciones para lo descriptivo y 30 para regresión) porque el sistema todavía no tiene suficiente historial real. Los datos los armamos tratando de que reflejen patrones de uso creíbles: reuniones cortas, jornadas parciales, jornadas completas, etc. Los cálculos los realizamos a mano aplicando las fórmulas vistas en clase, y después integramos los resultados en un módulo visual dentro de BookDesk para que el administrador pueda consultarlos.
...
\begin{itemize}[itemsep=4pt]
  \item Calculadora científica y planilla de cálculo para verificar los resultados.
  \item React 18 con Recharts para la presentación visual de los resultados en el sistema.
